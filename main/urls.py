...
urlpatterns = [
    ...
    path('admin-dashboard/leaves/approved-leaves', views.adminApprovedLeaves, name='adminApprovedLeaves'),
     path('admin-dashboard/leaves/your-leaves', views.adminapprovehisleaves, name='adminapprovehisleaves'),
     path('admin-dashboard/leaves/approve-leave/<pk>', views.adminapproverequest, name='adminapproverequest'),
     path('admin-dashboard/leaves/reject-leave/<pk>', views.admindeclinerequest, name='admindeclinerequest'),
